...
exports.run = async (SMCodes, message, args, author, prefix, server, user) =>{
    ...
    if(job === null) return message.channel.send("**[JOBS]** Você digitou uma profissão inválida, por favor digite uma profissão que esteja de acordo com nosso sistema, para ver as profissões digite » `"+prefix+"help empregos`");
